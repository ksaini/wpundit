...
function calendar(date)
{
	...
	//	var date = new Date();
        ...
        beg_j = beg_j.getDay();
        document.write('<table id="'+month+'" class="table-condensed table-bordered  sortable" onload="opacity(document.getElementById(\'cal_body\'),20);"><tbody id="cal_body"><tr><th colspan="7">'+date_today+'</th></tr>');
        ...
        for(i=1;i<=total;i++)
        {
                ...
                if(day==i)
                {
                        document.write('<td onclick="x(this)" id="'+i+'" class="cal_today">'+i+'</td>');
                }
				else if(week==0)
				{
                ...
                {
                        document.write('<td id="'+i+'" onclick="x(this)">'+i+'</td>');
                }
                week++;
                if(week==7)
                {
